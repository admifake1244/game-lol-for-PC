...
# Khởi tạo màn hình
# Thêm cờ SCALED và FULLSCREEN để tự động phóng to vừa màn hình điện thoại
...
try:
    ...
    # Dự phòng font mặc định nếu điện thoại không có font Arial
...
def main():
    ...
    while True:
        for event in pygame.event.get():
            ...
            # Hỗ trợ cả 3 thao tác: Phím Space (PC), Click chuột, và Chạm ngón tay (Mobile)
            is_jump_action = False
        ...
        if game_active:
            ...
            # Đổi chữ hiển thị sang Tap (Chạm) thay vì Space
            r_msg = font_msg.render("Tap to Restart", True, WHITE)
